...
class agent:
    ...
    def next_move(self, game_state, player_state):
        ...
        if (next_block == 'ob') or (next_block == 'sb'):
            if(player_state.ammo > 0):
                action = 'b'
                #TODO if single block bombed, leave it alone - suspended treasures list
                #TODO also track whether I can run after placing
        elif next_block == 'ib':
            ...
            if (next_block == 'b') and ((next_djikstra_location[0], next_djikstra_location[1]) != (opponent_location)):
                ...
                # Enemy
                # TODO murder - maybe just action 'b' for now??
    ...
    def djikstra_to_location(self, game_state):
        ...
        new_obstacles = []
        # TODO - Stretch : track disappearing blocks as well as appearing blast obstacles
        new_removal = []
        ...
        for future_step in range(35):
            ...
            # TODO Double check blast loading is working
        ...
        # TODO: ore is higher priority than treasure
